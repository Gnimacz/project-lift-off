...
// System		
        ...
        public static extern void System_CreateSound(IntPtr system, string filename, uint mode, int uk,
            out IntPtr sound);

        [DllImport("lib/fmodex.dll", EntryPoint = "FMOD_System_CreateStream")]
        public static extern void System_CreateStream(IntPtr system, string filename, uint mode, int uk,
            out IntPtr sound);

        [DllImport("lib/fmodex.dll", EntryPoint = "FMOD_System_PlaySound")]
        public static extern int System_PlaySound(IntPtr system, uint channelpref, IntPtr sound, bool paused,
            out uint channel);
...
// Channel
        ...
        public static extern void Channel_GetSpectrum(uint channel, float[] spectrumarray, int numvalues,
            uint channeloffset, int windowtype);
