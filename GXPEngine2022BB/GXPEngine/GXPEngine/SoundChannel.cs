...
namespace GXPEngine {
    ...
    public class SoundChannel {
        ...
        /// </summary>
        public float Pan {
            get { return _system.GetChannelPan(_id); }
        ...
        public bool IsPaused {
            get { return _system.GetChannelPaused(_id); }
        ...
        public bool IsPlaying {
            get { return _system.ChannelIsPlaying(_id); }
        }
        ...
        /// </value>
        public float Volume {
            get { return _system.GetChannelVolume(_id); }
            set {
                _volume = value;
                if (!_isMuted) {
