...
namespace GXPEngine.Core {
    ...
    public class GLContext {
        ...
        public void CreateWindow(int width, int height, bool fullScreen, bool vSync, int realWidth, int realHeight) {
            ...
            GL.glfwOpenWindow(realWidth, realHeight, 8, 8, 8, 8, 24, 0,
                (fullScreen ? GL.GLFW_FULLSCREEN : GL.GLFW_WINDOWED));
            ...
            GL.glfwSetWindowSizeCallback((int newWidth, int newHeight) => {
                ...
                GL.Ortho(0.0f, newWidth / _realToLogicWidthRatio, newHeight / _realToLogicHeightRatio, 0.0f, 0.0f,
                    1000.0f);
#if !STRETCH_ON_RESIZE
