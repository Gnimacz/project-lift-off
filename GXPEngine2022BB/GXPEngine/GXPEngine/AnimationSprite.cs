...
namespace GXPEngine {
    ...
    public class AnimationSprite : Sprite {
        ...
        /// </param> 
        public AnimationSprite(string filename, int cols, int rows, int frames = -1, bool keepInCache = false,
            bool addCollider = true) : base(filename, keepInCache, addCollider) {
            name = filename;
        ...
        /// If <c>true</c>, this sprite will have a collider that will be added to the collision manager.
        /// </param> 
        public AnimationSprite(System.Drawing.Bitmap bitmap, int cols, int rows, int frames = -1,
            bool addCollider = true) : base(bitmap, addCollider) {
